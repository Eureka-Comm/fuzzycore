...
public class DiscoveryAlgorithmTest {
    ...
    public void performanceEvaluationWithDiscoveryAlgorithm() {
        ...
        System.out.printf("Elapsed time %d ms, limit time %d ms, diff %d ms", algorithm.getComputeTime(), maximumTime,
    ...
    public void minTime() {
        ...
        System.out.printf("Elapsed time %d ms, limit time %d ms, diff %d ms\n", algorithm.getComputeTime(), maximumTime,
                (maximumTime - algorithm.getComputeTime()));
        DiscoveryResult result = algorithm.getResult();
        assertEquals(true, result.getData().size() == maximumNumberResult || maximumTime <= algorithm.getComputeTime());

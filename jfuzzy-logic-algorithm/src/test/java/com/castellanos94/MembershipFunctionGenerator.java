...
public class MembershipFunctionGenerator {
    ...
    public void fpgBoundaries() {
        ...
        assertEquals(10.0, boundary[0].getBeta(), FPGGenerator.DELTA);
        assertEquals(10.0, boundary[0].getGamma(), FPGGenerator.DELTA);
        assertEquals(1, 1, FPGGenerator.DELTA);

        assertEquals(20.0, boundary[1].getBeta(), FPGGenerator.DELTA);
        assertEquals(20.0, boundary[1].getGamma(), FPGGenerator.DELTA);
        assertEquals(1, 1, FPGGenerator.DELTA);
    }
    ...
    public void generateFPG() {
        ...
        assertNotEquals(fpg.getBeta(), fpg.getGamma(), FPGGenerator.DELTA);
        assertNotEquals(1, fpg.getM(), FPGGenerator.DELTA);
    }
